...
/* ============================================================
   MAIN
   ============================================================ */
export default function StructuralLab() {
  const init = useMemo(() => FRAME_PRESETS[0].make(), []);
  ...
  const [kind, setKind] = useState("frame");
  const [preset, setPreset] = useState(FRAME_PRESETS[0].name);
